...
'Alcona': {
    ...
    phone: '989-724-9400',
    officials: [
      { name: 'Elizabeth Reed', title: 'Prosecuting Attorney', party: null }, // appointed Sept 1, 2025 by circuit court judges; replaced Thomas Weichel (retired)
      ...
      { name: 'David Jagst', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Craig Johnston', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Carolyn Brummund', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Adam Brege', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'John Terry Small', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },
  ...
  'Alger': {
    ...
    phone: '906-387-7067',
    officials: [
      { name: 'Robert Steinhoff', title: 'Prosecuting Attorney', party: null }, // ran and won as Independent (no party affiliation)
      { name: 'Todd Brock', title: 'Sheriff', party: 'Republican' },
      { name: 'Joel VandeVelde', title: 'County Clerk / Register of Deeds', party: null }, // ran and won as Independent (no party affiliation)
      { name: 'Pam Johnson', title: 'Treasurer', party: 'Democratic' },
      { name: 'Robert Hughes', title: 'Commissioner (District 1)', party: null, district: 1 }, // appointed Oct 13 2025 to fill vacancy from Capogrossa resignation; serves through end of 2026
      { name: 'Dean Seaberg', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Michael Nettleton', title: 'Commissioner (District 3)', party: null, district: 3 }, // ran and won as Independent (no party affiliation)
      { name: 'Wyatt Seaberg', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Mickey Rondeau', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },
  ...
  'Allegan': {
    ...
    officials: [
      ...
      { name: 'Bob Genetski', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Sally Brooks', title: 'Treasurer', party: 'Republican' },
      { name: 'Chris Machiela', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Craig Van Beek', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Mark DeYoung', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Brad Lubbers', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Scott Beltman', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Gale Dugan', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },
  ...
  'Alpena': {
    ...
    phone: '989-354-9500',
    officials: [
      { name: 'Jesse Osmer', title: 'County Administrator', party: null }, // appointed April 2024; formerly elected commissioner for District 2
      { name: 'Cynthia Muszynski', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Erik Smith', title: 'Sheriff', party: 'Republican' },
      { name: 'Keri Bertrand', title: 'County Clerk', party: 'Republican' },
      { name: 'Cindy Cebula', title: 'Treasurer', party: 'Republican' },
      ...
      { name: 'John Kozlowski', title: 'Commissioner (District 8)', party: 'Republican', district: 8 },
    ],
  },
  ...
  'Antrim': {
    ...
    phone: '231-533-6265',
    officials: [
      { name: 'Jeremy Scott', title: 'County Administrator', party: null },
      { name: 'James Rossiter', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Kevin Hoch', title: 'Sheriff', party: 'Republican' },
      { name: 'Victoria Bishop', title: 'County Clerk', party: 'Republican' },
      { name: 'Sherry Comben', title: 'Treasurer', party: 'Republican' },
      { name: 'Patty Niepoth', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Leslie Meyers', title: 'Drain Commissioner', party: null }, // won Nov 2024 general as Independent over Libertarian Matthew Lundy
      { name: 'Bill Hefferan', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Jarris Rubingh', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Terry VanAlstine', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Jason Helwig', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Ray Scola', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },
  ...
  'Arenac': {
    ...
    phone: '989-846-4626',
    officials: [
      { name: 'Curtis Broughton', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'James Mosciski', title: 'Sheriff', party: 'Republican' },
      { name: 'Nancy Selle', title: 'County Clerk', party: 'Republican' },
      { name: 'Julie Hazeltine', title: 'Treasurer', party: 'Republican' },
      { name: 'Darlene Mikkola', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Steve Andrejewski', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Sally Mrozinski', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Lisa Salgat', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Bobbe Burke', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Harold Woolhiser', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Rachel Vallad', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },
  ...
  'Baraga': {
    ...
    officials: [
      ...
      { name: 'Wendy Goodreau', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Jill Tollefson', title: 'Treasurer', party: 'Republican' },
      { name: 'James Niemela', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Brad Dakota', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Craig Kent', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'William Menge', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Lee DeLeon', title: 'Commissioner (District 5)', party: null, district: 5 }, // appointed Feb 2025 to fill vacancy from Cichosz resignation (moved out of district)
    ],
  },
  ...
  'Barry': {
    ...
    phone: '269-945-1400',
    officials: [
      { name: 'Eric Zuzga', title: 'County Administrator', party: null },
      { name: 'Julie Nakfoor Pratt', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Dar Leaf', title: 'Sheriff', party: 'Republican' },
      { name: 'Sarah VanDenburg', title: 'County Clerk', party: 'Republican' },
      { name: 'Kelli Shumway', title: 'Treasurer', party: 'Republican' },
      { name: 'Emily Reed', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Jim Dull', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Bob Teunessen', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Catherine Getty', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'David Jackson', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Jon Smelker', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Mike Callton', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Marsha Bassett', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Bruce Campbell', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
      { name: 'David Hatfield', title: 'Commissioner (District 8)', party: 'Republican', district: 8 },
    ],
  },
  ...
  'Bay': {
    ...
    phone: '989-895-2055',
    officials: [
      { name: 'James Barcia', title: 'County Executive', party: 'Democratic' },
      { name: 'Michael Kanuszewski', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Troy Cunningham', title: 'Sheriff', party: 'Democratic' },
      { name: 'Katie Zanotti', title: 'County Clerk', party: 'Democratic' },
      { name: 'Weston Prince', title: 'Treasurer', party: 'Democratic' },
      { name: 'Brandon Krause', title: 'Register of Deeds', party: 'Democratic' },
      { name: 'Michael Rivard', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Kathy Niemiec', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Tim Banaszak', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Vaughn Begick', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Larry Beson', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Christopher Rupp', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Jesse Dockett', title: 'Commissioner (District 6)', party: 'Democratic', district: 6 },
      { name: 'Jerome Crete', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },
  ...
  'Benzie': {
    ...
    officials: [
      ...
      { name: 'Tammy Bowers', title: 'County Clerk', party: 'Republican' },
      { name: 'Kelly Long', title: 'Treasurer', party: 'Republican' },
      { name: 'Paula Eberhart', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Mike Fiebing', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Bob Roelofs', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Art Jeannot', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Christina Trigg', title: 'Commissioner (District 3)', party: 'Democratic', district: 3 },
      { name: 'Rhonda Nye', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Tim Markey', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Evan Warsecke', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Gary Sauer', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },

  // Board: 12 commissioner districts
  'Berrien': {
    name: 'Berrien County',
    ...
    officials: [
      ...
      { name: 'Amy Byrd', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Chuck Heit', title: 'Sheriff', party: 'Republican' },
      { name: 'Stacy Loar-Porter', title: 'County Clerk', party: 'Republican' },
      { name: 'Shelly Weich', title: 'Treasurer', party: 'Republican' },
      { name: 'Lora Gnodtke Freehling', title: 'Register of Deeds', party: 'Republican' },
      { name: 'George McManus III', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'David Vollrath', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Jon Hinkelman', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Chokwe Pitchford', title: 'Commissioner (District 3)', party: 'Democratic', district: 3 },
      { name: 'Mamie Yarbrough', title: 'Commissioner (District 4)', party: 'Democratic', district: 4 },
      { name: 'Rayonte Bell', title: 'Commissioner (District 5)', party: 'Democratic', district: 5 },
      { name: 'Julie Wuerfel', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Robert Harrison', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
      { name: 'Teri Sue Freehling', title: 'Commissioner (District 8)', party: 'Republican', district: 8 },
      { name: 'Alex Ott', title: 'Commissioner (District 9)', party: 'Republican', district: 9 },
      { name: 'R. McKinley Elliott', title: 'Commissioner (District 10)', party: 'Republican', district: 10 },
      { name: 'James Curran', title: 'Commissioner (District 11)', party: 'Republican', district: 11 },
      { name: 'Sharon Tyler', title: 'Commissioner (District 12)', party: 'Republican', district: 12 },
    ],
  },

  // Board: 5 commissioner districts
  // Note: Clerk and Register of Deeds are SEPARATE elected offices in Branch County.
  // Note: Branch County Interim Prosecuting Attorney Victor Fitz was appointed May 2026 following resignation from Cass County.
  'Branch': {
    name: 'Branch County',
    website: 'https://branchcounty.gov',
    phone: '517-279-4300',
    officials: [
      { name: 'Frank L. Walsh', title: 'County Administrator', party: null },
      { name: 'Victor Fitz', title: 'Prosecuting Attorney', party: 'Republican' }, // interim appointment May 2026; prior to this, office was vacant
      ...
      { name: 'Tim Stoll', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Rick Hollister', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Alan McClellan', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },

  // Board: 7 commissioner districts
  // Note: Clerk and Register of Deeds are COMBINED into one elected office in Calhoun County.
  // Note: Calhoun County uses "Water Resources Commissioner" instead of "Drain Commissioner" — this is an elected position.
  'Calhoun': {
    name: 'Calhoun County',
    website: 'https://www.calhouncountymi.gov',
    phone: '269-781-0700',
    officials: [
      { name: 'Kelli Scott', title: 'County Administrator/Controller', party: null },
      { name: 'David E. Gilbert', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Steven Hinkley', title: 'Sheriff', party: 'Republican' },
      { name: 'Kimberly A. Hinkley', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Melinda Weaver', title: 'Treasurer', party: null }, // appointed May 2, 2025 following death of Brian Wensauer; no partisan election
      { name: 'Tommy Miller', title: 'Water Resources Commissioner', party: 'Republican' },
      { name: 'Dominic Oo', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Monique French', title: 'Commissioner (District 2)', party: 'Democratic', district: 2 },
      { name: 'Al Morehart', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Dan Strowbridge', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Derek F. King', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Matthew M. Saxton', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Gary Tompkins', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },

  // Board: 8 commissioner districts
  // Note: Clerk and Register of Deeds are COMBINED into one elected office in Cass County.
  // Note: Prosecuting Attorney position is VACANT as of May 19, 2026 (Victor Fitz resigned).
  // Cass County Circuit Judge Mark A. Herman will appoint a successor; process ongoing.
  'Cass': {
    name: 'Cass County',
    ...
    officials: [
      ...
      { name: 'Jeff VanBelle', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Thomas Langley', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'James Lawrence', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Alan Northrop', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Jeremiah Jones', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Michael Grice', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Samuel Barrera', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Roseann Marchetti', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
      { name: 'RJ Lee', title: 'Commissioner (District 8)', party: 'Republican', district: 8 },
    ],
  },

  // Board: 6 commissioner districts
  // Note: Clerk and Register of Deeds are SEPARATE elected offices in Charlevoix County.
  // Note: Drain Commissioner position was vacant due to death of Dennis Jason (March 2024);
  // an election was held November 2024 but the winner's name could not be verified from available sources.
  'Charlevoix': {
    ...
    officials: [
      ...
      { name: 'Annemarie Conway', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
    ],
  },

  // Board: 7 commissioner districts
  // Note: County Clerk and Register of Deeds are COMBINED into one elected office in Cheboygan County.
  // Note: Districts 4 and 5 are filled by appointment (Ron Williams D4 resigned March 2025; Kim Pappas D5 resigned early 2025).
  // Thomas E. Eustice was appointed to D4; Dale Clarmont (former county sheriff) was appointed to D5.
  'Cheboygan': {
    name: 'Cheboygan County',
    website: 'https://www.cheboygancounty.net',
    phone: '231-627-8855',
    officials: [
      { name: 'Jeffery Lawson', title: 'County Administrator', party: null },
      { name: 'Melissa M. Goodrich', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Todd A. Ross', title: 'Sheriff', party: 'Republican' },
      { name: 'Karen Brewster', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Buffy Jo Weldon', title: 'Treasurer', party: 'Republican' },
      { name: 'Willie Neelis', title: 'Drain Commissioner', party: null }, // ran as Independent in 2024 general; won as unaffiliated candidate
      { name: 'Jeff Ostman', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Richard B. Sangster', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Michael Newman', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Thomas E. Eustice', title: 'Commissioner (District 4)', party: 'Republican', district: 4 }, // appointed April 2025 to fill vacancy
      { name: 'Dale Clarmont', title: 'Commissioner (District 5)', party: 'Republican', district: 5 }, // appointed March 2025 to fill vacancy
  ...
  // Board: 5 commissioner districts
  // Note: County Clerk and Register of Deeds are SEPARATE elected offices in Chippewa County.
  // Note: District 3 commissioner — Damon Lieurance (R) was the incumbent who ran in 2024 general against
  // Thomas L. Farnquist Sr. (Independent). Winner not confirmed from available sources; marked UNVERIFIED.
  'Chippewa': {
    name: 'Chippewa County',
    website: 'https://www.chippewacountymi.gov',
    phone: '906-635-6300',
    officials: [
      { name: null, title: 'County Administrator', party: null }, // UNVERIFIED — office exists but name not confirmed
      { name: 'Robert L. Stratton III', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Michael Bitnar', title: 'Sheriff', party: 'Republican' },
      { name: 'Steven J. Woodgate', title: 'County Clerk', party: 'Republican' },
      { name: 'Carmen M. Fazzari', title: 'Treasurer', party: 'Republican' },
      { name: 'Gigi Ferro', title: 'Register of Deeds', party: 'Republican' },
  ...
  // Board: 9 commissioner districts
  // Note: County Clerk and Register of Deeds are COMBINED into one elected office in Clare County.
  'Clare': {
    name: 'Clare County',
    website: 'https://clareco.net',
    phone: '989-539-0800',
    officials: [
      { name: 'Lori Phelps', title: 'County Administrator', party: null },
      { name: 'Andrew J. Santini', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'John S. Wilson', title: 'Sheriff', party: 'Republican' },
      { name: 'Lori Mott', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Jenny Beemer-Fritzinger', title: 'Treasurer', party: 'Republican' },
      { name: 'William Faber', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Marlene M. Housler', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Dale Majewski', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Jacob Gross', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Jeffery Haskell', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'David A. Hoefling', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Jack Kleinhardt', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Gabe Ambrozaitis', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
      { name: 'George Gilmore', title: 'Commissioner (District 8)', party: 'Republican', district: 8 },
      { name: 'Rickie Fancon', title: 'Commissioner (District 9)', party: 'Republican', district: 9 },
    ],
  },

  // Board: 7 commissioner districts
  // Note: County Clerk and Register of Deeds are COMBINED into one elected office in Clinton County.
  'Clinton': {
    name: 'Clinton County',
    website: 'https://www.clinton-county.org',
    phone: '989-224-5120',
    officials: [
      { name: 'John F. Fuentes', title: 'County Administrator/Controller', party: null },
      { name: 'Tony Spagnuolo', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Sean Dush', title: 'Sheriff', party: 'Republican' },
      { name: 'Debra A. Sutherland', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Steven E. Wiswasser', title: 'Treasurer', party: 'Republican' },
      { name: 'Phil Hanses', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Nicole Fickes', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Zach Rudat', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Bruce DeLong', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Brian Hurtekant', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Robert Showers', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'John Andrews', title: 'Commissioner (District 6)', party: 'Democratic', district: 6 },
      { name: 'Dwight J. Washington', title: 'Commissioner (District 7)', party: 'Democratic', district: 7 },
    ],
  },
  ...
  'Crawford': {
    ...
    phone: '989-344-3200',
    officials: [
      { name: 'Sierra R. Koch', title: 'Prosecuting Attorney', party: 'Republican' },
      ...
      { name: 'Shawn M. Kraycs', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Sandra Moore', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Matthew J. Moeller', title: 'Commissioner (District 6)', party: null, district: 6 }, // ran and won as Independent (no party)
      { name: 'Phil Lewis', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },

  // 5 districts; 3 commissioners recalled May 2024; new board seated Nov 2024
  'Delta': {
    name: 'Delta County',
    website: 'https://deltacountymi.gov',
    phone: '906-789-5100',
    officials: [
      { name: 'Lauren Wickman', title: 'Prosecuting Attorney', party: 'Republican' }, // confirmed: Ballotpedia candidate page and LinkedIn; ran and won as R in Nov 2024
      ...
      { name: 'Kelli J. van Ginhoven', title: 'Commissioner (District 4)', party: 'Democratic', district: 4 },
      { name: 'Matthew C. Jensen', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },

  // 5 districts; "Republicans sweep Dickinson board races" Nov 2024
  'Dickinson': {
    ...
    officials: [
      ...
      { name: 'Aaron M. Rochon', title: 'Sheriff', party: 'Republican' },
      { name: 'Carol Bronzyk', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Lorna Carey', title: 'Treasurer', party: 'Republican' },
      { name: 'Kevin Trevillian', title: 'Drain Commissioner', party: 'Republican' },
      ...
      { name: 'Dan Harrington', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Peter Swanson', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Victoria Jakel', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },

  // 15 districts; 2-year terms; board has 8 R / 7 D as of 2025
  // D1: Tim Barnes (R) elected Nov 2024, resigned; Andy Shaver (R) won special election 2025
  'Eaton': {
    name: 'Eaton County',
    ...
    officials: [
      ...
      { name: 'Dairus Reynnet', title: 'Treasurer', party: 'Republican' }, // won 2024 with 31,565 votes vs Terrance Augustine (D) 29,977
      { name: 'Richard Wagner', title: 'Drain Commissioner', party: 'Republican' }, // won Nov 2024
      { name: 'Andy Shaver', title: 'Commissioner (District 1)', party: 'Republican', district: 1 }, // appointed/elected via 2025 special election after Tim Barnes (R) resigned
      { name: 'Chris Arndt', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Jason Peek', title: 'Commissioner (District 3)', party: 'Democratic', district: 3 },
      { name: 'Brandon Haskell', title: 'Commissioner (District 4)', party: 'Democratic', district: 4 },
      { name: 'Jeanne Pearl-Wright', title: 'Commissioner (District 5)', party: 'Democratic', district: 5 },
      { name: 'Jane M. Whitacre', title: 'Commissioner (District 6)', party: 'Democratic', district: 6 },
      { name: 'Mark Mudry', title: 'Commissioner (District 7)', party: 'Democratic', district: 7 },
      { name: 'Kyle Jones', title: 'Commissioner (District 8)', party: 'Democratic', district: 8 },
      { name: 'Brian Droscha', title: 'Commissioner (District 9)', party: 'Republican', district: 9 },
      { name: 'Jacob Toomey', title: 'Commissioner (District 10)', party: 'Democratic', district: 10 }, // won by 11 votes; recount confirmed
      { name: 'Scott Hansen', title: 'Commissioner (District 11)', party: 'Republican', district: 11 },
      { name: 'Nicole Christensen', title: 'Commissioner (District 12)', party: 'Republican', district: 12 },
      { name: 'Jim Mott', title: 'Commissioner (District 13)', party: 'Republican', district: 13 },
      { name: 'Frank Holmes', title: 'Commissioner (District 14)', party: 'Republican', district: 14 },
      { name: 'Keith Barber', title: 'Commissioner (District 15)', party: 'Republican', district: 15 },
    ],
  },

  // 7 districts; 2-year terms; strongly Republican county
  // Emmet County has SEPARATE Clerk and Register of Deeds offices
  'Emmet': {
    name: 'Emmet County',
    ...
    officials: [
      ...
      { name: 'Matt Leirstein', title: 'Sheriff', party: 'Republican' }, // won Republican primary against Randy Kloss; no D candidate
      { name: 'Suzanne R. Kanine', title: 'County Clerk', party: 'Republican' }, // re-elected Nov 2024 over Democrat Elizabeth Lohman
      { name: 'Mary Mitchell', title: 'Treasurer', party: 'Republican' },
      { name: 'Karen Cosens', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Arden J. Bawkey', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Charles E. Laughbaum', title: 'Commissioner (District 1)', party: 'Republican', district: 1 }, // defeated Democrat Mark Sommers 1,874-1,199 Nov 2024
      { name: 'Brett Gooding', title: 'Commissioner (District 2)', party: 'Republican', district: 2 }, // won Republican primary by 1 vote over Neil Ahrens; ran as only candidate in Nov 2024
      { name: 'Don Mapes', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Rich Ginop', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Brian A. Gutowski', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'David M. White', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Matt Koontz', title: 'Commissioner (District 7)', party: 'Democratic', district: 7 },
    ],
  },

  // 9 districts; strongly Democratic county (Flint area)
  // Genesee County has COMBINED Clerk & Register of Deeds office (Domonique Clemons)
  'Genesee': {
    name: 'Genesee County',
    website: 'https://www.geneseecountymi.gov',
    phone: '810-257-3000',
    officials: [
      { name: 'David Leyton', title: 'Prosecuting Attorney', party: 'Democratic' },
      { name: 'Chris Swanson', title: 'Sheriff', party: 'Democratic' },
      { name: 'Domonique Clemons', title: 'County Clerk / Register of Deeds', party: 'Democratic' }, // combined office
      { name: 'Sam E. Muma', title: 'Treasurer', party: 'Democratic' },
      { name: 'Jeff Wright', title: 'Drain Commissioner', party: 'Democratic' },
      { name: 'Delrico J. Loyd', title: 'Commissioner (District 1)', party: 'Democratic', district: 1 },
      { name: 'Charles H. Winfrey', title: 'Commissioner (District 2)', party: 'Democratic', district: 2 },
      { name: 'Gary L. Goetzinger', title: 'Commissioner (District 3)', party: 'Republican', district: 3 }, // defeated Democrats in Nov 2024
      { name: 'Beverly Brown', title: 'Commissioner (District 4)', party: 'Democratic', district: 4 },
      ...
      { name: 'Martin L. Cousineau', title: 'Commissioner (District 7)', party: 'Democratic', district: 7 }, // won 52.33% vs R Lutullus Penton
      { name: 'Dale K. Weighill', title: 'Commissioner (District 8)', party: 'Democratic', district: 8 },
      { name: 'Brian K. Flewelling', title: 'Commissioner (District 9)', party: 'Republican', district: 9 }, // confirmed in Nov 2024 official results
    ],
  },

  // 5 districts; 2-year terms; Gladwin County has SEPARATE Clerk and Register of Deeds offices
  // All 5 results confirmed from Gladwin County official Nov 2024 election summary PDF
  'Gladwin': {
    name: 'Gladwin County',
    website: 'https://gladwincounty-mi.gov',
    phone: '989-426-7351',
    officials: [
      { name: 'Mark Toaz', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Michael Shea', title: 'Sheriff', party: 'Republican' },
      { name: 'Constance Thurlow-White', title: 'County Clerk', party: 'Republican' },
      { name: 'Christy Van Tiem', title: 'Treasurer', party: 'Republican' },
      { name: 'Ann Manning-Clayton', title: 'Register of Deeds', party: 'Republican' }, // won uncontested Nov 2024; 11,996 votes
      { name: 'Terry L. Walters', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Michael Visnaw', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Alan Donaldson', title: 'Commissioner (District 2)', party: 'Republican', district: 2 }, // defeated NPA Thomas Lennon 1,839-483
      { name: 'Tami O\'Donnell', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Karen L. Moore', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Thomas L. Winarski', title: 'Commissioner (District 5)', party: null, district: 5 }, // ran and won as NPA (No Party Affiliation) / Independent; 1,442 votes, ran alone
    ],
  },

  // 7 districts; 2-year terms
  'Gogebic': {
    name: 'Gogebic County',
    website: 'https://www.gogebic.gov',
    phone: '906-663-4518',
    officials: [
      { name: 'Nicholas J. Jacobs', title: 'Prosecuting Attorney', party: 'Republican' },
      ...
      { name: 'James Lorenson', title: 'Commissioner (District 4)', party: 'Democratic', district: 4 },
  ...
  // 5 districts; strongly Republican county
  'Gratiot': {
    name: 'Gratiot County',
    website: 'https://www.gratiotmi.com',
    phone: '989-875-5217',
    officials: [
      { name: 'Laura M. Bever', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Tom Clark', title: 'Sheriff', party: 'Republican' },
      { name: 'Angie Thompson', title: 'County Clerk', party: 'Republican' }, // Ballotpedia confirmed: ran and won as R; "elected for a 4 year term ending 12/31/2028" per certification
      { name: 'Terri R. Ball', title: 'Treasurer', party: 'Republican' }, // Ballotpedia confirmed elected R for 4-year term ending 12/31/2028
      { name: 'Kimberlee M. VanHoose', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Bernard James Barnes', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Dave Owens', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Jan Bunting', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Timothy Gay', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Steve Sopocy', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'George Bailey', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },
  ...
  'Hillsdale': {
    ...
    phone: '517-437-4321',
    officials: [
      { name: 'Jamie Wisniewski', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Scott Hodshire', title: 'Sheriff', party: 'Republican' },
      { name: 'Abe Dane', title: 'County Clerk', party: 'Republican' },
      { name: 'Stephenie Kyser', title: 'Treasurer', party: 'Republican' },
      { name: 'Nick Wheeler', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Matt Word', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Vinnie Ingles', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Mark Collins', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Brad Wiley', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'David Benzing', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Allen Leininger', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },

  'Houghton': {
    name: 'Houghton County',
    website: 'http://www.houghtoncounty.net',
    phone: '906-481-5300',
    officials: [
      { name: 'Chelsea Rheault', title: 'County Administrator', party: null },
      { name: 'Daniel Helmer', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Joshua Saaranen', title: 'Sheriff', party: 'Republican' },
      { name: 'Jennifer Kelly', title: 'County Clerk / Register of Deeds', party: 'Democratic' },
      { name: 'Lisa Mattila', title: 'Treasurer', party: 'Democratic' },
      { name: 'Nolan Miles', title: 'Drain Commissioner', party: null }, // appointed May 2025, replacing John Pekkala (D) who retired
      { name: 'Roy Tikkanen', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Jeff Keranen', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Glenn Anderson', title: 'Commissioner (District 3)', party: 'Democratic', district: 3 },
      { name: 'Bob Janssen', title: 'Commissioner (District 4)', party: 'Democratic', district: 4 },
      { name: 'Karl Britz', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },
  ...
  'Huron': {
    ...
    officials: [
      ...
      { name: 'Todd Maust', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'John Vaughan', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Sami Hunt', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Dave Murphy', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Joe Babcock', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },
  ...
  'Ingham': {
    ...
    phone: '517-676-7206',
    officials: [
      { name: 'Gregg Todd', title: 'County Controller/Administrator', party: null }, // appointed
      { name: 'John Dewane', title: 'Prosecuting Attorney', party: 'Democratic' },
      { name: 'Scott A. Wriggelsworth', title: 'Sheriff', party: 'Democratic' },
      { name: 'Barb Byrum', title: 'County Clerk', party: 'Democratic' },
      { name: 'Alan Fox', title: 'Treasurer', party: 'Democratic' },
      { name: 'Derrick Quinney', title: 'Register of Deeds', party: 'Democratic' },
      { name: 'Patrick E. Lindemann', title: 'Drain Commissioner', party: 'Democratic' },
      { name: 'Randy Maiville', title: 'Commissioner (District 1)', party: 'Republican', district: 1 }, // Vice Chair Pro Tem
      { name: 'Karla Ruest', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Chris Trubac', title: 'Commissioner (District 3)', party: 'Democratic', district: 3 }, // Vice Chair
      { name: 'Todd Tennis', title: 'Commissioner (District 4)', party: 'Democratic', district: 4 },
      { name: 'Myles Johnson', title: 'Commissioner (District 5)', party: 'Democratic', district: 5 },
      { name: 'Rachel Willis', title: 'Commissioner (District 6)', party: 'Democratic', district: 6 },
      { name: 'Thomas Morgan', title: 'Commissioner (District 7)', party: 'Democratic', district: 7 },
      { name: 'Robert Peña', title: 'Commissioner (District 8)', party: 'Democratic', district: 8 },
      { name: 'Ryan Sebolt', title: 'Commissioner (District 9)', party: 'Democratic', district: 9 }, // Board Chair
      { name: 'Gabrielle Lawrence', title: 'Commissioner (District 10)', party: 'Democratic', district: 10 },
      { name: 'Mark Grebner', title: 'Commissioner (District 11)', party: 'Democratic', district: 11 },
      { name: 'Irene Cahill', title: 'Commissioner (District 12)', party: 'Democratic', district: 12 },
      { name: 'Tanya Pratt', title: 'Commissioner (District 13)', party: 'Democratic', district: 13 },
      { name: 'Mark Polsdofer', title: 'Commissioner (District 14)', party: 'Democratic', district: 14 },
      { name: 'Monica Schafer', title: 'Commissioner (District 15)', party: 'Republican', district: 15 },
    ],
  },

  // District 3 VACANT -- Larry Tiejema (R) won Nov. 2024 election but resigned Feb. 2025 for health reasons; board could not agree on appointment; seat vacant until Nov. 2026 election
  'Ionia': {
    name: 'Ionia County',
    website: 'https://ioniacounty.org',
    phone: '616-527-5322',
    officials: [
      { name: 'Chad Shaw', title: 'County Administrator', party: null },
      { name: 'Kyle Butler', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Charlie Noll', title: 'Sheriff', party: 'Republican' },
      { name: 'Greg Geiger', title: 'County Clerk', party: 'Republican' },
      { name: 'Judith Clark', title: 'Treasurer', party: 'Republican' },
      { name: 'Tami Hewitt', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Robert Rose', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'David Hodges', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Tom Wirtz', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Jack Hesche', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Dave Kelley', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Paul Shattuck', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Jim Frewen', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },

  'Iosco': {
    name: 'Iosco County',
    website: 'https://iosco.net',
    phone: '989-362-4212',
    officials: [
      ...
      { name: 'April Johnson', title: 'Treasurer', party: 'Republican' },
      { name: 'Ericka Earl', title: 'Register of Deeds', party: 'Republican' }, // won 2024 R primary vs. Amy Jenkins; ran as sole general election candidate; confirmed in office per Apr. 2025 county minutes
      { name: 'Fred Strauer', title: 'Drain Commissioner', party: 'Democratic' },
      { name: 'Dale Hardy', title: 'Commissioner (District 1)', party: 'Democratic', district: 1 },
      { name: 'Craig Dutcher', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Kim Finley', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Dave Loeffler', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Mike O\'Farrell', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },

  'Iron': {
    name: 'Iron County',
    website: 'https://ironmi.com',
    phone: '906-875-3121',
    officials: [
      { name: 'Chad DeRouin', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Ryan Boehmke', title: 'Sheriff', party: 'Democratic' },
  ...
  'Isabella': {
    ...
    website: 'https://isabellacounty.org',
    phone: '989-317-4097',
    officials: [
      { name: 'Brian Smith', title: 'County Administrator', party: null },
      { name: 'Mark Kowalczyk', title: 'Prosecuting Attorney', party: 'Republican' }, // won Nov. 2024 general election; confirmed as current prosecutor on official county website
      { name: 'Michael Main', title: 'Sheriff', party: 'Republican' },
      { name: 'Minde Lux', title: 'County Clerk', party: 'Republican' },
      { name: 'Kathleen Schafer', title: 'Treasurer', party: 'Republican' },
      { name: 'Karen Jackson', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Robert Willoughby', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Frank Weber', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'David Campbell', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Tony Jaloszynski', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Jim Engler', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'James Moreno', title: 'Commissioner (District 5)', party: 'Democratic', district: 5 },
      { name: 'Angela Swaney', title: 'Commissioner (District 6)', party: 'Democratic', district: 6 },
      { name: 'Tyrone Hope', title: 'Commissioner (District 7)', party: 'Democratic', district: 7 },
    ],
  },
  ...
  'Jackson': {
    ...
    phone: '517-788-4450',
    officials: [
      { name: 'Michael Overton', title: 'County Administrator', party: null },
      { name: 'Kelsey Guernsey', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Gary Schuette', title: 'Sheriff', party: 'Republican' },
      { name: 'Cierra Sowle', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Karen Coffman', title: 'Treasurer', party: 'Republican' },
      { name: 'Geoffrey Snyder', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Chris Bair', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'George Walz', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Steve Kennedy', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Jacob Duckham', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Alex Shotwell', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Mike Poleski', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Jon Blondke', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
      { name: 'Earl Williams', title: 'Commissioner (District 8)', party: 'Democratic', district: 8 },
      { name: 'Amanda Snell', title: 'Commissioner (District 9)', party: 'Republican', district: 9 },
    ],
  },
  ...
  'Kalamazoo': {
    ...
    phone: '269-383-8821',
    officials: [
      { name: 'Kevin Catlin', title: 'County Administrator', party: null },
      { name: 'Jeffrey Getting', title: 'Prosecuting Attorney', party: 'Democratic' },
      { name: 'Richard Fuller III', title: 'Sheriff', party: 'Democratic' },
      { name: 'Meredith Place', title: 'County Clerk / Register of Deeds', party: 'Democratic' },
      { name: 'Thomas Whitener', title: 'Treasurer', party: 'Democratic' },
      { name: 'Jason Wiersma', title: 'Drain Commissioner', party: 'Democratic' },
      { name: 'Deb Rey', title: 'Commissioner (District 1)', party: 'Democratic', district: 1 },
      { name: 'Stephanie Strebs', title: 'Commissioner (District 2)', party: 'Democratic', district: 2 },
      { name: 'Roger Morales', title: 'Commissioner (District 3)', party: 'Democratic', district: 3 },
      { name: 'Julie Wheeler', title: 'Commissioner (District 4)', party: 'Democratic', district: 4 },
      { name: 'Tracy Taylor', title: 'Commissioner (District 5)', party: 'Democratic', district: 5 },
      { name: 'John Gisler', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Tami Heppler', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
      { name: 'Kathy Mazer', title: 'Commissioner (District 8)', party: 'Republican', district: 8 },
      { name: 'Matt DeLeeuw', title: 'Commissioner (District 9)', party: 'Democratic', district: 9 },
    ],
  },

  // Kalkaska County — Board: 7 commissioner districts
  // County Administrator: site lists "Administrator" dept headed by Pat Whiteford (Interim Administrator/CFO); appointed role
  'Kalkaska': {
    name: 'Kalkaska County',
    website: 'https://www.kalkaskacounty.net',
    phone: '231-258-3300',
    officials: [
      { name: 'Pat Whiteford', title: 'County Administrator (Interim)', party: null }, // UNVERIFIED -- site lists as interim; may change; formal title ambiguous
      { name: 'Ryan Ziegler', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Patrick J. Whiteford', title: 'Sheriff', party: 'Republican' },
      { name: 'Deborah L. Hill', title: 'County Clerk', party: 'Republican' },
      { name: 'Valerie Tracey', title: 'Treasurer', party: 'Republican' },
      { name: 'Jo Ann DeGraaf', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Seth H. Phillips', title: 'Drain Commissioner', party: 'Democratic' },
      { name: 'Truman Bicum', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Bob Baldwin', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Kohn Fisher', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'David Persons', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'David Comai', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Scott A. Matley', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Jeff Sieting', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },
  ...
  'Kent': {
    ...
    phone: '616-632-7570',
    officials: [
      { name: 'Alan G. Vanderberg', title: 'County Administrator/Controller', party: null }, // appointed
      { name: 'Chris Becker', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Michelle LaJoye-Young', title: 'Sheriff', party: 'Republican' },
      { name: 'Lisa Posthumus Lyons', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Peter MacGregor', title: 'Treasurer', party: 'Republican' },
      { name: 'Ken Yonker', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Ben Greene', title: 'Commissioner (District 1)', party: 'Republican', district: 1 }, // Board Chair
      ...
      { name: 'Lindsey Thiel', title: 'Commissioner (District 11)', party: 'Republican', district: 11 }, // Vice Chair
      ...
      { name: 'Steve Faber', title: 'Commissioner (District 18)', party: 'Democratic', district: 18 }, // Minority Vice Chair
  ...
  // Keweenaw County — Board: 5 commissioner districts; combined Clerk & Register of Deeds office; no separate Drain Commissioner
  // Keweenaw County does not have a separately elected Drain Commissioner
  'Keweenaw': {
    name: 'Keweenaw County',
    website: 'https://keweenawcountyonline.org',
    phone: '906-337-2229',
    officials: [
      { name: 'Charles Miller', title: 'Prosecuting Attorney', party: 'Democratic' },
      { name: 'Curt Pennala', title: 'Sheriff', party: 'Republican' },
  ...
  // Lake County — Board: 7 commissioner districts; combined Clerk & Register of Deeds office; Prosecutor is Independent
  // Lake County does not appear to have a separately elected Drain Commissioner; omitted per instructions
  'Lake': {
    name: 'Lake County',
    website: 'https://lakecountymi.gov',
    phone: '231-745-2776',
    officials: [
      { name: 'Tobi Lake', title: 'County Administrator', party: null },
      { name: 'Gregory T. Mick', title: 'Prosecuting Attorney', party: null }, // ran and won as Independent (no party affiliation)
      { name: 'Rich Martin', title: 'Sheriff', party: 'Republican' },
      { name: 'Patti Pacola', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Kellie Allen', title: 'Treasurer', party: 'Republican' },
      { name: 'Robert Sanders', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Howard Lodholtz', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Kristine Raymond', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Dawn Fuller', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Mike Seroczynski', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Jamie Russell', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Clyde Welford', title: 'Commissioner (District 7)', party: 'Democratic', district: 7 },
    ],
  },

  // Lapeer County — Board: 7 commissioner districts; separate Clerk and Register of Deeds offices
  // County Administrator/Controller position: could not verify current name from official site; omitting per instructions
  'Lapeer': {
    name: 'Lapeer County',
    ...
    officials: [
      ...
      { name: 'Scott R. McKenna', title: 'Sheriff', party: 'Republican' },
      { name: 'Theresa M. Spencer', title: 'County Clerk', party: 'Republican' },
      { name: 'Dana M. Miller', title: 'Treasurer', party: 'Republican' },
      { name: 'Amy R. Stearns', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Andy Wagner', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Scott McMahan', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Gary Howell', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Kevin Knisely', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Brad Haggadone', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'C. Ian Kempf', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Greg Wise', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Bryan Zender', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },

  // county clerk main line; courthouse 255 Clay St
  // Leelanau County — Board: 7 commissioner districts; separate Clerk and Register of Deeds; drain commissioner currently filled by appointment
  // Drain Commissioner: Timothy O'Non (R) elected Nov 2024, later resigned; Chet Janik appointed interim (appointed = party: null)
  'Leelanau': {
    ...
    officials: [
      ...
      { name: 'Mike Borkovich', title: 'Sheriff', party: 'Republican' },
      { name: 'Michelle Crocker', title: 'County Clerk', party: 'Republican' },
      { name: 'John A. Gallagher', title: 'Treasurer', party: 'Republican' },
      { name: 'Jennifer Grant', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Chet Janik', title: 'Drain Commissioner', party: null }, // appointed interim after elected commissioner resigned 2025
      { name: 'Rick Robbins', title: 'Commissioner (District 1)', party: 'Democratic', district: 1 },
      { name: 'Mark Walter', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Will Bunek', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Ty Wessell', title: 'Commissioner (District 4)', party: 'Democratic', district: 4 },
      { name: 'Alan Campbell', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Gwenne Allgaier', title: 'Commissioner (District 6)', party: 'Democratic', district: 6 },
      { name: 'Steve Yoder', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },

  // Lenawee County — Board: 9 commissioner districts; 8-1 Republican majority; separate Clerk, Register of Deeds, and Drain Commissioner
  'Lenawee': {
    name: 'Lenawee County',
    website: 'https://www.lenawee.mi.us',
    phone: '517-264-4599',
    officials: [
      { name: 'Kimberly L. Murphy', title: 'County Administrator', party: null },
      { name: 'Anna Marie Anzalone', title: 'Prosecuting Attorney', party: 'Republican' }, // UNVERIFIED party -- ran unopposed in 2024; party affiliation not confirmed from Ballotpedia label
      { name: 'Troy Bevier', title: 'Sheriff', party: 'Republican' }, // Ballotpedia confirms R candidate; county staff directory lists "Sheriff Troy Bevier"
      { name: 'Roxann Holloway', title: 'County Clerk', party: 'Republican' }, // UNVERIFIED party
      { name: 'Erin Van Dyke', title: 'Treasurer', party: 'Republican' }, // UNVERIFIED party
      { name: 'Carolyn S. Bater', title: 'Register of Deeds', party: 'Republican' }, // UNVERIFIED party
      { name: 'Edwin Scheffler', title: 'Drain Commissioner', party: 'Republican' }, // UNVERIFIED party
      { name: 'David Stimpson', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Dustin Krasny', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'David Aungst', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Beth Blanco', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'James W. Daly', title: 'Commissioner (District 5)', party: 'Democratic', district: 5 },
      { name: 'Terry Collins', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Kevon Martis', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
      { name: 'Ralph Tillotson', title: 'Commissioner (District 8)', party: 'Republican', district: 8 },
      { name: 'Jim Van Doren', title: 'Commissioner (District 9)', party: 'Republican', district: 9 },
    ],
  },

  // county clerk main line
  // Livingston County — Board: 9 commissioner districts; all 9 Republicans (Fiani D8 won as Republican over Democrat Hauptman)
  // County Administrator: position existed but could not confirm current appointed name from authoritative source
  'Livingston': {
    ...
    officials: [
      ...
      { name: 'Jennifer Gehringer Nash', title: 'Treasurer', party: 'Republican' },
      { name: 'Brandon Denby', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Brian Jonckheere', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Douglas Helzerman', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      ...
      { name: 'Jay Drick', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      ...
      { name: 'Nick Fiani', title: 'Commissioner (District 8)', party: 'Republican', district: 8 },
      { name: 'Jay Gross', title: 'Commissioner (District 9)', party: 'Republican', district: 9 },
    ],
  },

  // Luce County — Board: 4 commissioner districts; combined Clerk & Register of Deeds office
  // Drain Commissioner: could not verify from official Luce County sources whether this office is separately elected; omitted
  'Luce': {
    name: 'Luce County',
    website: 'https://www.lucecountymi.com',
    phone: '906-293-5521',
    officials: [
      { name: 'Cameron S. Harwell', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Eric L. Gravelle', title: 'Sheriff', party: 'Republican' },
      { name: 'Sharon J. Price', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Belinda Bridges', title: 'Treasurer', party: 'Republican' },
      { name: 'Nancy Morrison', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Michelle Clark', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Christine Rathje', title: 'Commissioner (District 3)', party: 'Democratic', district: 3 },
      { name: 'Anthony Kitzman', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
    ],
  },

  // Mackinac County — Board: 5 commissioner districts; separate Clerk and Register of Deeds offices
  // Drain Commissioner: could not verify from official Mackinac County sources; omitted
  'Mackinac': {
    name: 'Mackinac County',
    website: 'https://www.mackinaccounty.net',
    phone: '906-643-7300',
    officials: [
      { name: 'J. Stuart Spencer', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Edward Wilk', title: 'Sheriff', party: 'Republican' },
      { name: 'Hillary Vowell', title: 'County Clerk', party: 'Republican' },
      { name: 'Tina Jones Massey', title: 'Treasurer', party: 'Republican' },
      { name: 'Mary Jo Savard', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Daryl Schroeder', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Austin Kimberling', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'John Kling', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Mike Patrick', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Judy St. Louis-Scott', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },
  ...
  'Macomb': {
    ...
    phone: '586-469-7001',
    officials: [
      { name: 'Mark A. Hackel', title: 'County Executive', party: 'Democratic' },
      { name: 'Peter J. Lucido', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Anthony M. Wickersham', title: 'Sheriff', party: 'Democratic' },
      { name: 'Anthony G. Forlini', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Larry Rocca', title: 'Treasurer', party: 'Republican' },
      { name: 'Candice S. Miller', title: 'Public Works Commissioner', party: 'Republican' },
      { name: 'Ken Goike', title: 'Commissioner (District 1)', party: 'Republican', district: 1 }, // appointed
      { name: 'Phil Kraft', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Sylvia Grot', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Joe Sabatini', title: 'Commissioner (District 4)', party: 'Republican', district: 4 }, // Board Chair
      { name: 'Don VanSyckel', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Joseph Romano', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'James Perna', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
      { name: 'Antoinette Wallace', title: 'Commissioner (District 8)', party: 'Democratic', district: 8 },
      { name: 'Barbara Zinner', title: 'Commissioner (District 9)', party: 'Republican', district: 9 },
      { name: 'Harold Haugh', title: 'Commissioner (District 10)', party: 'Democratic', district: 10 }, // Vice Chair
      { name: 'Lisa Wojno', title: 'Commissioner (District 11)', party: 'Democratic', district: 11 },
      { name: 'Michael Howard', title: 'Commissioner (District 12)', party: 'Democratic', district: 12 },
      { name: 'Sarah Lucido', title: 'Commissioner (District 13)', party: 'Democratic', district: 13 },
    ],
  },
  ...
  'Manistee': {
    ...
    phone: '231-398-3504',
    officials: [
      { name: 'Lisa Sagala', title: 'County Controller / Administrator', party: null },
      { name: 'Jon Hauswirth', title: 'Prosecuting Attorney', party: 'Republican' }, // UNVERIFIED -- party from directory title only, not Ballotpedia-confirmed
      { name: 'Brian Gutowski', title: 'Sheriff', party: 'Republican' }, // UNVERIFIED -- party from directory title only, not Ballotpedia-confirmed
      { name: 'Michelle Johnson', title: 'County Clerk', party: 'Republican' }, // UNVERIFIED -- party from directory title only, not Ballotpedia-confirmed
      { name: 'Rachel Nelson', title: 'Treasurer', party: 'Republican' }, // UNVERIFIED -- party from directory title only, not Ballotpedia-confirmed
      { name: 'Kevin Mallison', title: 'Register of Deeds', party: 'Republican' }, // UNVERIFIED -- party from directory title only, not Ballotpedia-confirmed
      { name: 'Gary R. Schwaiger', title: 'Drain Commissioner', party: 'Republican' }, // UNVERIFIED -- party from directory title only, not Ballotpedia-confirmed
      { name: 'Janice McCraner', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Richard Schmidt', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Nikki Koons', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Eric Gustad', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Jeff Dontz', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Karen Goodman', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Shayne Machen', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },
  ...
  'Marquette': {
    ...
    phone: '906-225-8330',
    officials: [
      { name: 'Jenna Nelson', title: 'Prosecuting Attorney', party: 'Democratic' },
      ...
      { name: 'Dana LaLonde', title: 'Commissioner (District 4)', party: 'Democratic', district: 4 },
      { name: 'Bill Nordeen', title: 'Commissioner (District 5)', party: 'Democratic', district: 5 },
      { name: 'Karen Alholm', title: 'Commissioner (District 6)', party: 'Democratic', district: 6 },
    ],
  },
  ...
  'Mason': {
    ...
    phone: '231-843-7999',
    officials: [
      { name: 'Kaitlyn Szczypka', title: 'County Administrator', party: null },
      { name: 'Beth Hand', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Kim Cole', title: 'Sheriff', party: 'Republican' },
      { name: 'Cheryl Kelly', title: 'County Clerk', party: 'Republican' },
      { name: 'Andrew Kmetz IV', title: 'Treasurer', party: 'Republican' },
      { name: 'Diane L. Englebrecht', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Larry Protasiewicz', title: 'Drain Commissioner', party: 'Republican' }, // UNVERIFIED -- party not confirmed via Ballotpedia
      { name: 'Nick Krieger', title: 'Commissioner (District 1)', party: 'Democratic', district: 1 },
      { name: 'Les Johnson', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Jordan Hartley', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Lewis Squires', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Steven Hull', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Janet Anderson', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Ron Bacon', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },
  ...
  'Mecosta': {
    ...
    phone: '231-592-0100',
    officials: [
      { name: 'Jonathan Peterson', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Brian Miller', title: 'Sheriff', party: 'Republican' },
      { name: 'Marcee M. Purcell', title: 'County Clerk', party: 'Republican' },
      { name: 'Sherry Earnest', title: 'Treasurer', party: 'Republican' },
      { name: 'Karen Hahn', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Karla Miller', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Jeff Jackson', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Greg Adams', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Chris Zimmerman', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Gary Lambrix', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Tom O\'Neil', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Chris Jane', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'William Routley', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },
  ...
  'Menominee': {
    ...
    phone: '906-863-9968',
    officials: [
      { name: 'Jeffrey T. Rogg', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Darrin Kudwa', title: 'Sheriff', party: 'Republican' },
      { name: 'Marc Kleiman', title: 'County Clerk / Register of Deeds', party: 'Democratic' },
      { name: 'Barbara Parrett', title: 'Treasurer', party: 'Republican' },
      { name: 'Steven Gromala', title: 'Commissioner (District 1)', party: 'Democratic', district: 1 },
      { name: 'Patricia Mueller', title: 'Commissioner (District 2)', party: null, district: 2 }, // Independent -- ran with no party affiliation (2024 ballot)
      { name: 'Larry Phelps', title: 'Commissioner (District 3)', party: null, district: 3 }, // Independent -- ran with no party affiliation (2024 ballot)
      { name: 'Donald Park', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Zak Aubert', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Connie Westrich', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Jeff Carlson', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
      { name: 'Nick Hanchek', title: 'Commissioner (District 8)', party: null, district: 8 }, // Independent -- ran with no party affiliation (2024 ballot)
      { name: 'Larry Johnson Jr.', title: 'Commissioner (District 9)', party: 'Republican', district: 9 },
    ],
  },

  'Midland': {
    name: 'Midland County',
    website: 'https://midlandcountymi.gov',
    phone: '989-832-6739',
    officials: [
      { name: 'Bridgette Gransden', title: 'County Administrator', party: null },
      ...
      { name: 'Jennifer Anway', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Joe Sova', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Jeanette Snyder', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Mark Bone', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Larry Schuelke', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Jim Stamas', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Todd Gambrell', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Eric Dorrien', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Alaynah Smith', title: 'Commissioner (District 7)', party: 'Democratic', district: 7 },
    ],
  },
  ...
  'Missaukee': {
    ...
    phone: '231-839-4967',
    officials: [
      { name: 'David A. Den Houten', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Wilbur Yancer', title: 'Sheriff', party: 'Republican' },
      { name: 'Adriana Fowler', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Lori S. Cox', title: 'Treasurer', party: 'Republican' },
      { name: 'Lan Bridson', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Frank Vanderwal', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'David Turner', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Roger Ouwinga', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Dean Smallegan', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Star Hughston', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Gary E. Gladu Jr.', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },
  ...
  'Monroe': {
    ...
    phone: '734-240-7000',
    officials: [
      { name: 'Jeffrey A. Yorkey', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Troy Goodnough', title: 'Sheriff', party: 'Republican' },
      { name: 'Annamarie Osment', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Jesse Stanford', title: 'Treasurer', party: 'Republican' },
      { name: 'Jenna Morse', title: 'Drain Commissioner', party: 'Republican' }, // UNVERIFIED -- appointed interim March 2025; Nov 2025 special election result not confirmed
      { name: 'David Hoffman', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Dale Biniecki', title: 'Commissioner (District 2)', party: 'Republican', district: 2 }, // won Nov 2025 special election (56%)
      { name: 'Dawn Asper', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Jay Heinzerling', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Brian Lamour', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'David Vensel', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'David Swartout', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
      { name: 'Greg Moore Jr.', title: 'Commissioner (District 8)', party: 'Republican', district: 8 },
      { name: 'J. Henry Lievens', title: 'Commissioner (District 9)', party: 'Republican', district: 9 },
    ],
  },
  ...
  'Montcalm': {
    ...
    officials: [
      ...
      { name: 'William J. Barnwell', title: 'Sheriff', party: 'Republican' },
      { name: 'Kristen Millard', title: 'County Clerk', party: 'Republican' },
      { name: 'JoAnne Vukin', title: 'Treasurer', party: 'Republican' },
      { name: 'Todd Sattler', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Nathan Alexander', title: 'Commissioner (District 1)', party: null, district: 1 }, // ran and won as Independent in 2024
      { name: 'Chris Johnston', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Adam Petersen', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Jack Johnson', title: 'Commissioner (District 4)', party: 'Republican', district: 4 }, // appointed Aug 2025, replacing Scott Painter who resigned July 2025
      { name: 'Charlie Mahar', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Patrick Q. Carr', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Matt Murray', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },

  'Montmorency': {
    name: 'Montmorency County',
    website: 'https://www.montcounty.org',
    phone: '989-785-8044',
    officials: [
      { name: 'Aprille Williamson', title: 'County Controller', party: null },
      { name: 'Vicki Kundinger', title: 'Prosecuting Attorney', party: null }, // Independent -- not Republican or Democratic
      { name: 'Chad Brown', title: 'Sheriff', party: 'Republican' },
      { name: 'Cheryl Neilsen', title: 'County Clerk', party: 'Republican' },
      { name: 'Linsey Rogers', title: 'Treasurer', party: 'Republican' },
      { name: 'Teresa Walker', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Charles Arbor', title: 'Drain Commissioner', party: null }, // UNVERIFIED party
      { name: 'Mary Hardies', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Kelly Karll', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Lloyd Peltier', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Michelle LaRose', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Michelle Hamlin', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },
  ...
  'Muskegon': {
    ...
    officials: [
      ...
      { name: 'Michael J. Poulin', title: 'Sheriff', party: 'Democratic' },
      { name: 'Karen D. Buie', title: 'County Clerk', party: 'Democratic' },
      { name: 'Tony Moulatsiotis', title: 'Treasurer', party: 'Democratic' },
      { name: 'William Moulatsiotis', title: 'Register of Deeds', party: 'Democratic' },
      { name: 'Stephanie Barrett', title: 'Water Resources Commissioner', party: 'Democratic' },
      { name: 'Kim Cyr', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'J. Brett Herman', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Michelle Hazekamp', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Chris McGuigan', title: 'Commissioner (District 4)', party: 'Democratic', district: 4 },
      { name: 'Charles Nash', title: 'Commissioner (District 5)', party: 'Democratic', district: 5 },
      { name: 'Jessica Cook', title: 'Commissioner (District 6)', party: 'Democratic', district: 6 },
      { name: 'Darrell Paige', title: 'Commissioner (District 7)', party: 'Democratic', district: 7 },
    ],
  },

  'Newaygo': {
    name: 'Newaygo County',
    website: 'https://www.newaygocountymi.gov',
    phone: '231-689-7234',
    officials: [
      { name: 'Christopher Wren', title: 'County Administrator', party: null },
      { name: 'Rachel Robinson', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Bob Mendham', title: 'Sheriff', party: 'Republican' },
      { name: 'Jason VanderStelt', title: 'County Clerk', party: 'Republican' },
      { name: 'Jason O\'Connell', title: 'Treasurer', party: 'Republican' },
      { name: 'Stewart Sanders', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Dale E. Twing', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Paul Mellema', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Bryan Kolk', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Chuck Trapp', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'James Maike', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Lori Tubbergen Clark', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Brenda Bird', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Mike Kruithoff', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },
  ...
  'Oakland': {
    ...
    officials: [
      ...
      { name: 'Michael J. Bouchard', title: 'Sheriff', party: 'Republican' },
      { name: 'Lisa Brown', title: 'County Clerk / Register of Deeds', party: 'Democratic' },
      { name: 'Robert Wittenberg', title: 'Treasurer', party: 'Democratic' },
      { name: 'Jim Nash', title: 'Water Resources Commissioner', party: 'Democratic' },
      { name: 'Dave Woodward', title: 'Commissioner (District 1)', party: 'Democratic', district: 1 }, // Board Chair
      { name: 'Penny Luebs', title: 'Commissioner (District 2)', party: 'Democratic', district: 2 },
      { name: 'Ann Erickson Gault', title: 'Commissioner (District 3)', party: 'Democratic', district: 3 },
      { name: 'Brendan Johnson', title: 'Commissioner (District 4)', party: 'Democratic', district: 4 },
      { name: 'Michael Spisz', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Michael Gingell', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Bob Hoffman', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
      { name: 'Karen Joliat', title: 'Commissioner (District 8)', party: 'Republican', district: 8 },
      { name: 'Angela Powell', title: 'Commissioner (District 9)', party: 'Democratic', district: 9 },
      { name: 'Kristen Nelson', title: 'Commissioner (District 10)', party: 'Democratic', district: 10 },
      { name: 'Marcia Gershenson', title: 'Commissioner (District 11)', party: 'Democratic', district: 11 }, // Vice Chair
      { name: 'Christine Long', title: 'Commissioner (District 12)', party: 'Republican', district: 12 },
      { name: 'Phil Weipert', title: 'Commissioner (District 13)', party: 'Republican', district: 13 },
      { name: 'Robert Smiley', title: 'Commissioner (District 14)', party: 'Republican', district: 14 },
      { name: 'Gwen Markham', title: 'Commissioner (District 15)', party: 'Democratic', district: 15 },
      { name: 'William Miller III', title: 'Commissioner (District 16)', party: 'Democratic', district: 16 },
      { name: 'Yolanda Smith Charles', title: 'Commissioner (District 17)', party: 'Democratic', district: 17 },
      { name: 'Linnie Taylor', title: 'Commissioner (District 18)', party: 'Democratic', district: 18 },
      { name: 'Charlie Cavell', title: 'Commissioner (District 19)', party: 'Democratic', district: 19 },
    ],
  },

  'Oceana': {
    name: 'Oceana County',
    website: 'https://oceana.mi.us',
    phone: '231-873-4328',
    officials: [
      { name: 'Tracy Byard', title: 'County Administrator', party: null },
      { name: 'Joseph J. Bizon', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Craig Mast', title: 'Sheriff', party: 'Republican' },
      { name: 'Melanie Coon', title: 'County Clerk', party: 'Republican' },
      { name: 'Mary Lou Phillips', title: 'Treasurer', party: 'Republican' },
      { name: 'Richard Hodges', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Michelle Martin', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Tim Beggs', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Phil Morse', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Craig Hardy', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Paul Erickson', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Robert Walker', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },

  'Ogemaw': {
    name: 'Ogemaw County',
    website: 'https://www.ocmi.us',
    phone: '989-345-0215',
    officials: [
      { name: 'LaDonna A. Schultz', title: 'Prosecuting Attorney', party: 'Democratic' },
      { name: 'Brian D. Gilbert', title: 'Sheriff', party: 'Republican' },
      { name: 'Breck L. Gildner', title: 'County Clerk', party: 'Republican' },
      { name: 'Nicole Cooper', title: 'Treasurer', party: null }, // Appointed May 2026 to fill vacancy after elected Treasurer Caren Piglowski (R) resigned
      { name: 'Denise Simmons', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Michael DeMatio', title: 'Drain Commissioner', party: 'Democratic' },
      { name: 'Jenny David', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Roger Mayhew', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Charles Wiltse', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Mark Surbrook', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Craig Scott', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },

  'Ontonagon': {
    name: 'Ontonagon County',
    website: 'https://ontonagoncounty.org',
    phone: '906-884-4255',
    officials: [
      { name: 'Rudolph Perhalla', title: 'Prosecuting Attorney', party: null }, // UNVERIFIED party; not on 2024 ballot (4-yr term, elected 2022)
      { name: 'Dale Rantala', title: 'Sheriff', party: 'Democratic' },
      { name: 'Stacy Preiss', title: 'County Clerk / Register of Deeds', party: 'Democratic' },
      { name: 'Michele Smith', title: 'Treasurer', party: 'Democratic' },
      { name: 'John Cane', title: 'Commissioner (District 1)', party: null, district: 1 }, // NPA (No Party Affiliation)
      { name: 'Richard Bourdeau', title: 'Commissioner (District 2)', party: 'Democratic', district: 2 },
      { name: 'Robert Nousiainen', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Carl Nykanen', title: 'Commissioner (District 4)', party: 'Democratic', district: 4 },
      { name: 'Ron Store', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },
  ...
  'Osceola': {
    ...
    phone: '231-832-6196',
    officials: [
      { name: 'Tim Ladd', title: 'County Coordinator', party: null },
      { name: 'Anthony Badovinac', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Mark Cool', title: 'Sheriff', party: 'Republican' },
      { name: 'Tracey Cochran', title: 'County Clerk', party: 'Republican' },
      { name: 'Tonia M. Hartline', title: 'Treasurer', party: 'Republican' },
      { name: 'Heather E. Gray', title: 'Register of Deeds', party: 'Republican' },
      { name: 'David Belden', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Gregory Gydesen', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Mark Gregory', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'David Turner', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Timothy Michell', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'James Custer', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Scott Stieg', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Russ Nehmer', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },
  ...
  'Oscoda': {
    ...
    phone: '989-826-1110',
    officials: [
      { name: 'Kristie McGregor', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Taylor Kann', title: 'Sheriff', party: 'Republican' },
      { name: 'Libby Marsh-Shephard', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'William M. Kendall', title: 'Treasurer', party: 'Republican' },
      { name: 'Chuck Varner', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Tom McCauley', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Jackie Bondar', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Ted Handrich', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
    ],
  },
  ...
  'Otsego': {
    ...
    phone: '989-732-6484',
    officials: [
      { name: 'Fred Ventresco', title: 'County Administrator', party: null },
      { name: 'Michael A. Rola', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Matthew J. Nowicki', title: 'Sheriff', party: 'Republican' },
      { name: 'Susan I. DeFeyter', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Paula Wright', title: 'Treasurer', party: 'Republican' },
      ...
      { name: 'Brett McVannel', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      ...
      { name: 'Dana Wingo', title: 'Commissioner (District 8)', party: 'Republican', district: 8 },
      { name: 'Rob Weaver', title: 'Commissioner (District 9)', party: 'Republican', district: 9 },
    ],
  },

  // Ottawa County — 11 commissioner districts
  'Ottawa': {
    name: 'Ottawa County',
    website: 'https://www.miottawa.org',
    phone: '616-738-4000',
    officials: [
      { name: 'Patrick Waterman', title: 'County Administrator', party: null },
      { name: 'Sarah Matwiejczyk', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Eric DeBoer', title: 'Sheriff', party: 'Republican' },
      { name: 'Justin F. Roebuck', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      ...
      { name: 'Doug R. Zylstra', title: 'Commissioner (District 3)', party: 'Democratic', district: 3 },
      ...
      { name: 'John Teeples', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
      ...
      { name: 'Josh Brugger', title: 'Commissioner (District 10)', party: 'Republican', district: 10 },
  ...
  'Roscommon': {
    ...
    phone: '989-275-8021',
    officials: [
      { name: 'Jodi Valentino', title: 'County Administrator/Controller', party: null },
      { name: 'Michael T. Edwards', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Edward F. Stern', title: 'Sheriff', party: 'Republican' },
      { name: 'Michelle M. Stevenson', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Marcie L. Dankert', title: 'Treasurer', party: 'Republican' },
      { name: 'Chase Schepke', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'David Russo', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Kim Morley', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Rex Wolfsen', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Marc J. Milburn', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Darlene Sensor', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },

  // Saginaw County — 11 commissioner districts
  'Saginaw': {
    name: 'Saginaw County',
    website: 'https://www.saginawcountymi.gov',
    phone: '989-790-5200',
    officials: [
      { name: 'Mary Catherine Hannah', title: 'County Administrator', party: null },
      { name: 'John A. McColgan Jr.', title: 'Prosecuting Attorney', party: 'Democratic' },
      { name: 'William L. Federspiel', title: 'Sheriff', party: 'Democratic' },
      { name: 'Vanessa Guerra', title: 'County Clerk', party: 'Democratic' },
      { name: 'Tim N. Novak', title: 'Treasurer', party: 'Democratic' },
      { name: 'Katie Albosta Kelly', title: 'Register of Deeds', party: 'Democratic' },
      { name: 'Brian J. Wendling', title: 'Public Works Commissioner', party: 'Democratic' },
      { name: 'Mark Piotrowski', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Jack Tany', title: 'Commissioner (District 2)', party: 'Democratic', district: 2 },
      { name: 'Rich Spitzer', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Sheldon Matthews', title: 'Commissioner (District 4)', party: 'Democratic', district: 4 },
      { name: 'Tracey Slodowski', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Denny Harris', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'John L. Kaczynski', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
      { name: 'Gerald Little', title: 'Commissioner (District 8)', party: 'Democratic', district: 8 },
      { name: 'Christopher Boyd', title: 'Commissioner (District 9)', party: 'Democratic', district: 9 },
      { name: 'Lisa Coney', title: 'Commissioner (District 10)', party: 'Democratic', district: 10 },
      { name: 'Michael A. Webster', title: 'Commissioner (District 11)', party: 'Democratic', district: 11 },
    ],
  },

  // Sanilac County — 7 commissioner districts
  'Sanilac': {
    name: 'Sanilac County',
    website: 'https://www.sanilaccounty.gov',
    phone: '810-648-2313',
    officials: [
      { name: 'Nathan Roskey', title: 'County Administrator/Controller', party: null },
      { name: 'Mark E. Davidson', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Paul D. Rich', title: 'Sheriff', party: 'Republican' },
      { name: 'Leslie A. Hilgendorf', title: 'County Clerk', party: 'Republican' },
      { name: 'Trudy M. Bowers', title: 'Treasurer', party: 'Republican' },
      { name: 'Michele VanNorman', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Doug Sweet', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Jon Block', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Roger C. Ballard', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Gary Heberling', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Bill Sarkella', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Christine J. Lee', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Evans Ehardt', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'John L. Moody', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },

  // Schoolcraft County — 5 commissioner districts; Clerk/Register of Deeds combined; no County Administrator (small UP county)
  'Schoolcraft': {
    name: 'Schoolcraft County',
    website: 'https://www.schoolcraftcounty.net',
    phone: '906-341-3618',
    officials: [
      { name: 'Timothy R. Noble', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Charles E. Willour', title: 'Sheriff', party: 'Republican' },
      { name: 'Beth A. Edwards', title: 'County Clerk / Register of Deeds', party: 'Republican' },
      { name: 'Heather LaLonde', title: 'Treasurer', party: 'Republican' },
      { name: 'Craig Reiter', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Bruce Birr', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Troy Bassett', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Paul Walker', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Dan P. Hoholik', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
    ],
  },

  // Shiawassee County — 7 commissioner districts
  'Shiawassee': {
    name: 'Shiawassee County',
    website: 'https://shiawassee.net',
    phone: '989-743-2374',
    officials: [
      { name: 'Brian Boggs', title: 'County Administrator', party: null },
      { name: 'Scott Koerner', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Doug Chapman', title: 'Sheriff', party: 'Republican' },
      { name: 'Caroline D. Wilson', title: 'County Clerk', party: 'Republican' },
      { name: 'Julie L. Sorenson', title: 'Treasurer', party: 'Republican' },
      { name: 'Lori S. Kimble', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Brent Singer', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Josh Haley', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Gregory Brodeur', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Gary Holzhausen', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Bill Johnson', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Brad Howard', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Cindy L. Garber', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },
      { name: 'Matthew Shepard', title: 'Commissioner (District 7)', party: 'Republican', district: 7 },
    ],
  },
  ...
  'Tuscola': {
    ...
    phone: '989-672-3775',
    officials: [
      { name: 'Erica Dibble', title: 'County Controller/Administrator', party: null },
      { name: 'Erica K. Walle', title: 'Prosecuting Attorney', party: 'Republican' },
      { name: 'Ryan Robinson', title: 'Sheriff', party: 'Republican' },
      { name: 'Jodi Fetting', title: 'County Clerk', party: 'Republican' },
      { name: 'Ashley Bennett', title: 'Treasurer', party: 'Republican' },
      { name: 'Marianne Brandt', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Dara Hood', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Nancy Barrios', title: 'Commissioner (District 1)', party: null, district: 1 }, // UNVERIFIED party -- appointed Oct 2025 to fill vacancy; party affiliation not confirmed in sources
      { name: 'Thomas Bardwell', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
  ...
  // Washtenaw County — 9 commissioner districts; Clerk/Register of Deeds combined; Water Resources Commissioner (not "Drain Commissioner")
  'Washtenaw': {
    name: 'Washtenaw County',
    website: 'https://www.washtenaw.org',
    phone: '734-222-3800',
    officials: [
      { name: 'Gregory Dill', title: 'County Administrator', party: null },
      { name: 'Eli Savit', title: 'Prosecuting Attorney', party: 'Democratic' },
      { name: 'Alyshia Dyer', title: 'Sheriff', party: 'Democratic' },
      { name: 'Lawrence Kestenbaum', title: 'County Clerk / Register of Deeds', party: 'Democratic' },
      { name: 'Latitia Lamelle Sharp', title: 'Treasurer', party: 'Democratic' },
      { name: 'Gretchen Driskell', title: 'Water Resources Commissioner', party: 'Democratic' },
      { name: 'Jason Maciejewski', title: 'Commissioner (District 1)', party: 'Democratic', district: 1 },
      { name: 'Crystal Lyte', title: 'Commissioner (District 2)', party: 'Democratic', district: 2 },
      { name: 'Shannon Beeman', title: 'Commissioner (District 3)', party: 'Democratic', district: 3 },
      { name: 'Caroline L. Sanders', title: 'Commissioner (District 4)', party: 'Democratic', district: 4 },
      { name: 'Justin D. Hodge', title: 'Commissioner (District 5)', party: 'Democratic', district: 5 },
      { name: 'Annie Somerville', title: 'Commissioner (District 6)', party: 'Democratic', district: 6 },
      { name: 'Andy LaBarre', title: 'Commissioner (District 7)', party: 'Democratic', district: 7 },
      { name: 'Yousef Rabhi', title: 'Commissioner (District 8)', party: 'Democratic', district: 8 },
      { name: 'Katie Scott', title: 'Commissioner (District 9)', party: 'Democratic', district: 9 },
    ],
  },
  ...
  'Wayne': {
    ...
    phone: '313-224-0286',
    officials: [
      { name: 'Warren C. Evans', title: 'County Executive', party: 'Democratic' },
      { name: 'Kym L. Worthy', title: 'Prosecuting Attorney', party: 'Democratic' },
      { name: 'Raphael Washington', title: 'Sheriff', party: 'Democratic' },
      { name: 'Cathy M. Garrett', title: 'County Clerk', party: 'Democratic' },
      { name: 'Eric R. Sabree', title: 'Treasurer', party: 'Democratic' },
      { name: 'Bernard J. Youngblood', title: 'Register of Deeds', party: 'Democratic' },
      { name: 'Tim Killeen', title: 'Commissioner (District 1)', party: 'Democratic', district: 1 },
      { name: 'Jonathan C. Kinloch', title: 'Commissioner (District 2)', party: 'Democratic', district: 2 },
      { name: 'Martha G. Scott', title: 'Commissioner (District 3)', party: 'Democratic', district: 3 },
      ...
      { name: 'Alisha Bell', title: 'Commissioner (District 7)', party: 'Democratic', district: 7 }, // Board Chair
      ...
      { name: 'Glenn S. Anderson', title: 'Commissioner (District 12)', party: 'Democratic', district: 12 },
      { name: 'Sam Baydoun', title: 'Commissioner (District 13)', party: 'Democratic', district: 13 }, // Vice Chair Pro Tem
      { name: 'Alex Garza', title: 'Commissioner (District 14)', party: 'Democratic', district: 14 },
      { name: 'Joseph Palamara', title: 'Commissioner (District 15)', party: 'Democratic', district: 15 }, // Vice Chair
    ],
  },

  // Wexford County — 9 commissioner districts
  'Wexford': {
    name: 'Wexford County',
    website: 'https://wexfordcounty.org',
    phone: '231-779-9453',
    officials: [
      ...
      { name: 'Roxanne L. Snyder', title: 'Register of Deeds', party: 'Republican' },
      { name: 'Michael Solomon', title: 'Drain Commissioner', party: 'Republican' },
      { name: 'Aaron Sogge', title: 'Commissioner (District 1)', party: 'Republican', district: 1 },
      { name: 'Jason Nelson', title: 'Commissioner (District 2)', party: 'Republican', district: 2 },
      { name: 'Mark Nyman', title: 'Commissioner (District 3)', party: 'Republican', district: 3 },
      { name: 'Sandy Bengelink', title: 'Commissioner (District 4)', party: 'Republican', district: 4 },
      { name: 'Michael Bush', title: 'Commissioner (District 5)', party: 'Republican', district: 5 },
      { name: 'Julie Theobald', title: 'Commissioner (District 6)', party: 'Republican', district: 6 },

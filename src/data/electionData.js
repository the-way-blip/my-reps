...
export const MI_ELECTIONS = [
  // Special elections
  {
    id: 'mi-sd35-special-primary-2026',
    name: 'Michigan SD-35 Special Primary',
    type: 'special',
    date: 'February 3, 2026',
    description: 'Special primary election for Michigan State Senate District 35, vacated by U.S. Rep. Kristen McDonald Rivet when she was elected to Congress. Chedrick Greene (D) and Jason Tunney (R) won their respective primaries.',
    registrationDeadline: 'January 19, 2026 (by mail/online) or February 3, 2026 (in person at clerk)',
    earlyVotingStart: 'January 25, 2026',
    absenteeDeadline: 'January 30, 2026 (by mail) or February 2, 2026 (in person)',
    offices: ['State Senate District 35'],
  },
  {
    id: 'mi-sd35-special-general-2026',
    name: 'Michigan SD-35 Special General & Local Elections',
    type: 'special',
    date: 'May 5, 2026',
    description: 'Special general election for Michigan State Senate District 35 (Chedrick Greene vs. Jason Tunney vs. Ali Sledz), plus select local elections across Michigan communities.',
    registrationDeadline: 'April 20, 2026 (by mail/online) or May 5, 2026 (in person at clerk)',
    earlyVotingStart: 'April 26, 2026',
    absenteeDeadline: 'May 1, 2026 (by mail, 5 p.m.) or May 4, 2026 (in person, 4 p.m.)',
    offices: ['State Senate District 35'],
  },
  // May local/school elections
  {
    id: 'mi-may-school-election-2026',
    name: 'Michigan May School & Local Election',
    type: 'local',
    date: 'May 5, 2026',
    description: 'Many Michigan school districts hold elections in May for school board seats, operating millages, bond proposals, and other local issues. Held concurrently with the SD-35 special general election in some areas.',
    registrationDeadline: 'April 20, 2026 (by mail/online) or May 5, 2026 (in person at clerk)',
    earlyVotingStart: 'April 26, 2026',
    absenteeDeadline: 'May 1, 2026 (by mail, 5 p.m.) or May 4, 2026 (in person, 4 p.m.)',
    offices: [
      'School board seats (varies by district)',
      'School operating millages',
      'School bond proposals',
      'Library board seats',
      'Community college board seats',
      'Local millage renewals and proposals',
    ],
  },
  // Statewide primary
  {
    ...
    registrationDeadline: 'July 20, 2026 (by mail/online) or August 4, 2026 (in person at clerk)',
    earlyVotingStart: 'July 26, 2026',
    absenteeDeadline: 'July 31, 2026 (by mail, 5 p.m.) or August 3, 2026 (in person, 4 p.m.)',
    keyRaces: [
      {
  ...
  // November local races (on same ballot as general)
  {
    id: 'mi-november-local-2026',
    name: 'Michigan November Local Elections',
    type: 'local',
    date: 'November 3, 2026',
    description: 'Local races on the November general election ballot across Michigan. Includes city councils, township boards, county commissioners, judges, and local ballot proposals. Held concurrently with state and federal races.',
    registrationDeadline: 'October 19, 2026 (by mail/online) or November 3, 2026 (in person at clerk)',
    earlyVotingStart: 'October 25, 2026',
    absenteeDeadline: 'October 30, 2026 (by mail, 5 p.m.) or November 2, 2026 (in person, 4 p.m.)',
    offices: [
      'City council seats',
      'Township board trustees and supervisors',
      'County commissioners',
      'District and circuit court judges',
      'County clerks, treasurers, and prosecutors',
      'Drain commissioners',
      'Local ballot proposals and millages',
    ],
  },
  // General election
  {
